...
$(document).ready(function(){
    //      data:'nom_etd='+nom_etd+'prenom_etd='+prenom_etd+'id_pro='+id_pro,
     $('#rech').on('click', function(){
     	var nom_etd = $('#nom_etd').val();
     	var annee_unive = $('#annee_unive').val();
     	var id_pro = $('#promotion').val();
     	var prenom_etd = $('#prenom_etd').val();
     	var email_etd = $('#email').val();
     	if (prenom_etd && nom_etd &&id_pro && annee_unive && email_etd){
     	
$.ajax({
                type:'POST',
                url:'ajaxDataadd.php',

                data:{nom_etd:nom_etd ,prenom_etd:prenom_etd,id_pro:id_pro,email_etd:email_etd},
	...
	alert("champs obligatoire");
      ...
      $('#annee_unive').on('change', function(){
        ...
        if(annee_unive){
            ...
            $('#promotion').html('<option value="">Select promo first</option>');
...
<section>
							...
							<section>
								...
								<select required="" id="promotion" name="state" >
									<option disabled selected value="">choisis la promotion</option>
								</select>
							...
							<section>
								...
								<input  type="text"  name="addpromo" id="nom_etd" required="">
							</section>
							<section>
								<label for="class">Prenom :</label>
								<input  type="text" name="addpromo" id="prenom_etd" required="">
							</section>
							<section>
								
								<label for="class">Email :</label>
								<input  type="text"  name="addpromo" id="email" required="">
							</section>
						...
						<div class="col-xxs-12 col-xs-12 text-center">
							<input type="button" id="rech" name="submit" value="Ajouté Etudiant" class="btn btn-primary btn-lg" style="margin-bottom: 10px;" />
