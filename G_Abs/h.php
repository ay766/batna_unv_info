...
function update(){
                                    Highcharts.getJSON('http://localhost/G_abs/j.json', function (data) {
...
?>
		...
		<div class="chart-area" id="containerr" style="height:500px;">
                            </div>
					...
					<h2>Ajouté Promotions</h2>
						...
						<div class="col-xxs-12 col-xs-12">
							<section>
								...
								<input  type="text" name="displayData" id="displayData">
							</section>
							<section>
