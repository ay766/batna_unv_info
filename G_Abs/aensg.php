...
$(document).ready(function(){
    //      data:'nom_etd='+nom_etd+'prenom_etd='+prenom_etd+'id_pro='+id_pro,
     $('#rech').on('click', function(){
     	...
     	var annee_univer = $('#promotion').val();
     	var prenom_ens = $('#prenom_ens').val();
     	if (prenom_ens && nom_ens && annee_univer){
     	
$.ajax({
                type:'POST',
                url:'ajaxDataadd.php',
         
                data:{nom_ens:nom_ens,prenom_ens:prenom_ens,annee_univer:annee_univer},
				...
				<div class="s-holder">
					<h2>Ajouté Enseignants</h2>
						...
						<div class="col-xxs-12 col-xs-12">
							...
							<section>
								<label for="class">Annee Universitaire :</label>
							...
							<section>
								...
								<input  type="text"  name="addpromo" id="nom_ens" required="">
							</section>
							<section>
								<label for="class">Prenom :</label>
								<input  type="text" name="addpromo" id="prenom_ens" required="">
							</section>
						...
						<div class="col-xxs-12 col-xs-12 text-center">
							<input type="button" id="rech" name="submit" value="Ajouté Enseignant" class="btn btn-primary btn-lg" style="margin-bottom: 10px;" />
						</div>
