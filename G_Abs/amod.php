...
$.ajax({
                ...
                data:{id_promodu:id_pro ,desg:desg},
	...
	alert("champs obligatoire");
      ...
      $('#annee_univem').on('change', function(){
        ...
        if(annee_unive){
            $.ajax({
                ...
                success:function(html){
                    $('#promotionm').html(html);
                }
            }); 
        }else{
            $('#promotionm').html('<option value="">Select année first</option>');
          
        }
    });
      $('#promotionm').on('change', function(){
        var promotionm = $(this).val();
        if(promotionm){
            $.ajax({
                type:'POST',
                url:'ajaxDataadd.php',
                data:'promotionm='+promotionm,
                success:function(html){
                    $('#tablerech').html(html);
                }
            }); 
...
<section>
								...
								<select required="" id="annee_univem" name="state" >
									<option value="">choisis l'annee universitaire</option>
							...
							<section>
								...
								<select required="" id="promotionm" name="state" >
									<option disabled selected value="">select annee first</option>
								</select>
								
							</section>
							<section>
								
								<label for="class">desigation :</label>
								<input  type="text"  name="addpromo" id="desg" required="">
							</section>
						...
						<div class="col-xxs-12 col-xs-12 text-center">
							<input type="button" id="rech" name="submit" value="Ajouté Module" class="btn btn-primary btn-lg" style="margin-bottom: 10px;" />
						</div>
			...
			<div><table id="tablerech" style="border-width: 1px;  border-style: solid; margin-top:20px; margin-bottom: 30px; margin-left: 10px; width: 90%"> <tr><th>id_module</th>   <th>designation</th>  </tr>
